...
public class EntityClientControllerTest extends AbstractTest {
    @Test
    public void whenGetAllEntities_thenReturnEntitiesList() throws Exception {
    ...
    public void whenCreateEntity_thenCreateEntityAndEvictCache() throws  Exception {
        ...
        String expectedResponse = objectMapper.writeValueAsString(new DatabaseEntity
                (UUID.randomUUID(), "newEntity", ENTITY_DATE));
    ...
    @Test
    public void whenUpdateEntity_thenCUpdateEntityAndEvictCache() throws  Exception {
        assertTrue(redisTemplate.keys("*").isEmpty());
        ...
        String expectedResponse = objectMapper.writeValueAsString(new DatabaseEntity
                (UUID.randomUUID(), "updateName", ENTITY_DATE));
